...
Elm.Native.Decimal.make = function(localRuntime) {
    ...
    return localRuntime.Native.Decimal.values = {
        ...
        absoluteValue: function(d) {return d.absoluteValue();},
        cosine: function(d) {return d.cosine();},
        cubeRoot: function(d) {return d.cubeRoot();},
        hyperbolicCosine: function(d) {return d.hyperbolicCosine();},
        hyperbolicSine: function(d) {return d.hyperbolicSine();},
        hyperbolicTangent: function(d) {return d.hyperbolicTangent();},
        inverseCosine: function(d) {return d.inverseCosine();},
        inverseHyperbolicCosine: function(d) {return d.inverseHyperbolicCosine();},
        inverseHyperbolicSine: function(d) {return d.inverseHyperbolicSine();},
        inverseHyperbolicTangent: function(d) {return d.inverseHyperbolicTangent();},
        inverseSine: function(d) {return d.inverseSine();},
        inverseTangent: function(d) {return d.inverseTangent();},
        naturalExponential: function(d) {return d.naturalExponential();},
        naturalLogarithm: function(d) {return d.naturalLogarithm();},
        negated: function(d) {return d.negated();},
        sine: function(d) {return d.sine();},
        squareRoot: function(d) {return d.squareRoot();},
        tangent: function(d) {return d.tangent();},
        truncated: function(d) {return d.truncated();},
        isFinite: function(d) {return d.isFinite();},
        isInteger: function(d) {return d.isInteger();},
        isInt: function(d) {return d.isInt();},
        isNaN: function(d) {return d.isNaN();},
        isNegative: function(d) {return d.isNegative();},
        isNeg: function(d) {return d.isNeg();},
        isPositive: function(d) {return d.isPositive();},
        isPos: function(d) {return d.isPos();},
        isZero: function(d) {return d.isZero();},
        ...
        greaterThan: F2(function(a, b) {return a.greaterThan(b);}),
        gt: F2(function(a, b) {return a.gt(b);}),
        greaterThanOrEqualTo: F2(function(a, b) {return a.greaterThanOrEqualTo(b);}),
        gte: F2(function(a, b) {return a.gte(b);}),
        lessThan: F2(function(a, b) {return a.lessThan(b);}),
        lt: F2(function(a, b) {return a.lt(b);}),
        lessThanOrEqualTo: F2(function(a, b) {return a.lessThanOrEqualTo(b);}),
        lte: F2(function(a, b) {return a.lte(b);}),
        equals: F2(function(a, b) {return a.equals(b);}),
        eq: F2(function(a, b) {return a.eq(b);}),
        fromNumber: Decimal,
        withDecimalsToFixed: F2(function(dp, d) {return d.toFixed(dp);}),
        precision: function(d) {return d.precision;},
        rounding: function(d) {return d.rounding;},
        minE: function(d) {return d.minE;},
        maxE: function(d) {return d.maxE;},
        toExpNeg: function(d) {return d.toExpNeg;},
        toExpPos: function(d) {return d.toExpPos;},
        modulo: function(d) {return d.modulo;},
        customDecimalFromNumber: function(config) {return Decimal.clone(config);},
        toString: function(d) {return d.toString();},
        valueOf: function(d) {return d.valueOf();},
        Decimal: Decimal
    };
};
